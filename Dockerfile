...
ADD --chmod=755 "https://github.com/AlexxIT/go2rtc/releases/download/v1.9.2/go2rtc_linux_${TARGETARCH}" go2rtc
...
HEALTHCHECK --start-period=300s --interval=15s --timeout=5s --retries=3 \
